...
public class DemoSurveySelectionOption : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    // Sets up the option
    public void Setup(DemoSurveyManager _surveyManager, int _sortId, string displayText)
    {
